#!/usr/bin/env python3
"""charm4py benchmark driver for 28_reduce_smallest_odd_number"""
...
def validate(gen_fn):
    for _ in range(MAX_VALIDATION_ATTEMPTS):
        x = [random.randint(0, 100) for _ in range(1024)]
...
def main(args):
    ...
    try:
        gen_fn = load_fn(opts.generated, "smallestOdd")
    except Exception:
    ...
    data = [random.randint(0, 100) for _ in range(PROBLEM_SIZE)]
