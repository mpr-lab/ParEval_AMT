#!/usr/bin/env python3
"""charm4py benchmark driver for 56_transform_negate_odds"""
import argparse
...
def main(args):
    ...
    try:
        gen_fn = load_fn(opts.generated, "negateOddsAndHalveEvens")
    ...
    if not is_valid:
        charm.exit(); return
    data = [random.randint(1, 100) for _ in range(PROBLEM_SIZE)]
    t = 0.0
